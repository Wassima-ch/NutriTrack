...
export default function LoginScreen({ navigation }: any) {
  ...
  return (
    <SafeAreaView className="flex-1 bg-fresh">
      {/* 1. KeyboardAvoidingView pour remonter les champs sous le clavier */}
      ...
      >
        <ScrollView 
          ...
          // 2. Ajout de paddingHorizontal et paddingBottom ici pour le scroll
...
>
  <ArrowLeft size={24} color="#A3C981" />
          ...
          <View className="space-y-4 mt-6">
            ...
            <TouchableOpacity className="items-end px-1">
