...
Une fois que la commande est lancée, un **QR Code** géant va apparaître dans votre terminal.
...
| Action | Commande |
| :--- | :--- |
| Entrer dans le dossier | `cd NutriTrack` |
| Installer les modules | `npm install` |
| Lancer avec nettoyage cache | `npx expo start -c` |
| Lancer normalement | `npx expo start` |
